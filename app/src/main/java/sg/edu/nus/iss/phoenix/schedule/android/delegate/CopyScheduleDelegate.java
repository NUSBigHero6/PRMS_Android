...
public class CopyScheduleDelegate extends AsyncTask<ProgramSlot, Void, Boolean> {
    ...
    protected Boolean doInBackground(ProgramSlot... params) {
        ...
        //builtUri = Uri.withAppendedPath(builtUri, "copyProgramSlot").buildUpon().build();
        ...
        try {
            json.put("programName", params[0].getProgramName());
    ...
    protected void onPostExecute(Boolean result) {
        scheduleController.ScheduleCopied(result.booleanValue());
    }
}
